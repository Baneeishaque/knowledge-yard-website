                        ...
                        <div class="span12">
                            <div class="box">
                                ...
                                <div class="box-content box-nomargin">
                                    ...
                                    <form method="POST" action="forms_3.php?txt_name=<?php
                                    echo $_GET["txt_name"];?>&sel_gender=<?php
                                    echo $_GET["sel_gender"];?>&dob_picker=<?php
                                    echo $_GET["dob_picker"];?>&sel_religion=<?php
                                    echo $_GET["sel_religion"];?>&caste=<?php
                                    echo $_GET["caste"];?>&sel_community=<?php
                                    echo $_GET["sel_community"];?>" enctype="multipart/form-data" class='validate form-horizontal'>
