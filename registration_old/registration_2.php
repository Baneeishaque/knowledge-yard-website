    ...
    <body>
        ...
        <div id="container">  	  
            ...
            <div class="box">
                ...
                <form name="s" action="registration_3.php" method="get" <!-- onSubmit="return valid()--> ">
                    <table align="center" cellpadding="10" cellspacing="10" width="800">
                        
                        <tr>
                            <td><font face="Times New Roman"  size="+1"><strong>Name Of Father/ Guardian</strong></font></td>
                            <td><input type="text" name="unn" class="b"></td>


                        </tr>
                        <tr>
                            <td><font face="Times New Roman"  size="+1"><strong>Occupation Of Father/ Guardian</strong></font></td>
                            <td><input type="text" name="unn" class="b"></td>


                        </tr>
                        <tr>
                            <td><font face="Times New Roman"  size="+1"><strong>Permanent Address</strong></font></td>
                            <td><textarea cols="77" rows="4" class="b"></textarea></td>
                        ...
                        <tr>
                            ...
                            <!-- <td><input type="checkbox" name="unn" class="b">Same As Above</td> -->


                        </tr>
                        <tr>
                            <td><font face="Times New Roman"  size="+1"><strong>Communication Address</strong></font></td>
                            <td><textarea cols="77" rows="4" class="b"></textarea></td>


                        </tr>
                        <tr>
                            <td><font face="Times New Roman"  size="+1"><strong>Telephone</strong></font></td>
                            <td><input type="text" name="unn" class="b"></td>
